      ...
      <main>
        <div class="container c">
          ...
          <div class="banks">
            ...
            <div class="bank m" style="cursor: pointer;" onclick="window.open('<?php echo $sdHost;?>/in/offer/1261?aid=63223&source=adwords&campaign=<?php echo $gclid;?>&promo=<?php echo $promo;?>&tid1=UA-113174594-1&tid2=<?php echo $tid2;?>');">
              <a href="#"  target="_blank" id="creditkasa" class="bank-img"><img id="miloan" src="images/mycredit.png" alt="miloan"></a>
              <div class="bank-features">
                <b>100 грн в подарок за 1 оформленный кредит !</b>
              </div>
              <table class="bank-properties">
...
<!--              -->
           ...
           <!--  <div class="bank m" style="cursor: pointer;"
            ...
            <!-- <div class="bank" style="cursor: pointer;" onclick="window.open('<?php echo $sdHost;?>/in/offer/1712?aid=63223&source=adwords&campaign=<?php echo $gclid;?>&promo=<?php echo $promo;?>&tid1=UA-113174594-1&tid2=<?php echo $tid2;?>');">
    ...
    <div class="b-popup" style="display: none;">
      <div class="b-popup-content">
        ...
        <div class="offers">
          ...
          <div class="offers-itm"
            onclick="window.open('https://go.salesdoubler.net/in/offer/1711?aid=63223&source=adwords&campaign=<?php echo $gclid;?>&promo=<?php echo $promo;?>&tid1=UA-113174594-1&tid2=<?php echo $tid2;?>');">
            <div class="logo-offer">
              <img id="miloan" src="images/e-groshi.png" alt="miloan">
            </div>
            <div class="sum-offer">
              <img src="img/ico-grn.png" alt="">
              <p>20.000</p>
    ...
    <a href="https://teleg.one/PrivatCreditbot" class="telegram_chat" target="_blank"></a>
