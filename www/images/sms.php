...
require_once 'ECPMByOffers.php';
    ...
    if (!empty($_REQUEST['utm_term'])) {
        $tid2 = substr(htmlspecialchars(trim($_REQUEST['utm_term'])),0,200);
    }
    ...
    if (!empty($_REQUEST['utm_content'])) {
        $content = substr(htmlspecialchars(trim($_REQUEST['utm_content'])),0,200);
    }
...
<!-- End Google Tag Manager (noscript) -->
 ...
 <div class="bank">
    <a href="<?php echo $sdHost;?>/in/offer/1844?aid=63223&source=<?php echo $source;?>&campaign=<?php echo $campaign;?>&promo=<?php echo $medium;?>&tid1=<?php echo $content;?>&tid2=<?php echo $tid2;?>" onclick="fbq('track', 'Lead');" id="mycredit" target="_blank" class="bank-img"><img id="mycredit" src="images/creditplus.png" alt="creditkasa"></a>
    ...
    <a href="<?php echo $sdHost;?>/in/offer/1844?aid=63223&source=<?php echo $source;?>&campaign=<?php echo $campaign;?>&promo=<?php echo $medium;?>&tid1=<?php echo $content;?>&tid2=<?php echo $tid2;?>"  id="mycredit" target="_blank" class="bank-link">Получить займ</a>
</div>   
                    
   <div class="bank">
    <a href="<?php echo $sdHost;?>/in/offer/2187?aid=63223&source=<?php echo $source;?>&campaign=<?php echo $campaign;?>&promo=<?php echo $medium;?>&tid1=<?php echo $content;?>&tid2=<?php echo $tid2;?>" onclick="fbq('track', 'Lead');" id="mycredit" target="_blank" class="bank-img"><img id="mycredit" src="images/e-cash-logo.png" alt="creditkasa"></a>
    ...
    <a href="<?php echo $sdHost;?>/in/offer/2187?aid=63223&source=<?php echo $source;?>&campaign=<?php echo $campaign;?>&promo=<?php echo $medium;?>&tid1=<?php echo $content;?>&tid2=<?php echo $tid2;?>"  id="mycredit" target="_blank" class="bank-link">Получить займ</a>
</div>       
                    
<div class="bank">
    <a href="<?php echo $sdHost;?>/in/offer/1261?aid=63223&source=<?php echo $source;?>&campaign=<?php echo $campaign;?>&promo=<?php echo $medium;?>&tid1=<?php echo $content;?>&tid2=<?php echo $tid2;?>" onclick="fbq('track', 'Lead');" target="_blank" id="dinero" class="bank-img"><img id="dinero" src="images/mycredit.svg" alt="Dinero"></a>
    <div class="bank-features">
        <b>Под 0 процентов!</b>
    ...
    <a href="<?php echo $sdHost;?>/in/offer/1261?aid=63223&source=<?php echo $source;?>&campaign=<?php echo $campaign;?>&promo=<?php echo $medium;?>&tid1=<?php echo $content;?>&tid2=<?php echo $tid2;?>" onclick="fbq('track', 'Lead');" id="dinero" target="_blank" class="bank-link">Получить займ</a>
</div>                  
              
<div class="bank">
    <a href="<?php echo $sdHost;?>/in/offer/1571?aid=63223&source=<?php echo $source;?>&campaign=<?php echo $campaign;?>&promo=<?php echo $medium;?>&tid1=<?php echo $content;?>&tid2=<?php echo $tid2;?>" onclick="fbq('track', 'Lead');" target="_blank" id="dinero" class="bank-img"><img id="dinero" src="images/dinero.png" alt="Dinero"></a>
    <div class="bank-features">
        <b>Под 0 процентов!</b>
    ...
    <a href="<?php echo $sdHost;?>/in/offer/1571?aid=63223&source=<?php echo $source;?>&campaign=<?php echo $campaign;?>&promo=<?php echo $medium;?>&tid1=<?php echo $content;?>&tid2=<?php echo $tid2;?>" onclick="fbq('track', 'Lead');" id="dinero" target="_blank" class="bank-link">Получить займ</a>
</div>                       
  ...
  <div class="bank">
    <a href="<?php echo $sdHost;?>/in/offer/1272?aid=63223&source=<?php echo $source;?>&campaign=<?php echo $campaign;?>&promo=<?php echo $medium;?>&tid1=<?php echo $content;?>&tid2=<?php echo $tid2;?>" onclick="fbq('track', 'Lead');" id="svgroshi" target="_blank" class="bank-img"><img  id="svgroshi" src="images/shvidko-groshi-min.png
" alt="Moneyveo"></a>
    <div class="bank-features">
        <b>Под 2 процента!</b>
    </div>
    ...
    <a href="<?php echo $sdHost;?>/in/offer/1272?aid=63223&source=<?php echo $source;?>&campaign=<?php echo $campaign;?>&promo=<?php echo $medium;?>&tid1=<?php echo $content;?>&tid2=<?php echo $tid2;?>" onclick="fbq('track', 'Lead');" id="svgroshi" target="_blank" class="bank-link">Получить займ</a>
</div>  
                    
    <div class="bank">
    <a href="<?php echo $sdHost;?>/in/offer/1200?aid=63223&source=<?php echo $source;?>&campaign=<?php echo $campaign;?>&promo=<?php echo $medium;?>&tid1=<?php echo $content;?>&tid2=<?php echo $tid2;?>" onclick="fbq('track', 'Lead');" target="_blank" id="creditplus" class="bank-img"><img id="creditplus" src="images/GlobalCredit.png" alt="vasha"></a>
    <div class="bank-features">
        <b>Под 0 процентов!</b>
    </div>
    <table class="bank-properties">
    ...
    <a href="<?php echo $sdHost;?>/in/offer/1200?aid=63223&source=<?php echo $source;?>&campaign=<?php echo $campaign;?>&promo=<?php echo $medium;?>&tid1=<?php echo $content;?>&tid2=<?php echo $tid2;?>" onclick="fbq('track', 'Lead');" id="vasha" target="_blank" class="bank-link">Получить займ</a>
</div>  
                         
                    
     <div class="bank">
    <a href="<?php echo $sdHost;?>/in/offer/250?aid=63223&source=<?php echo $source;?>&campaign=<?php echo $campaign;?>&promo=<?php echo $medium;?>&tid1=<?php echo $content;?>&tid2=<?php echo $tid2;?>" onclick="fbq('track', 'Lead');" target="_blank" id="moneyveo" class="bank-img"><img id="moneyveo" src="images/moneyveo.png" alt="Moneyveo"></a>
    <div class="bank-features">
        <b>Под 0 процентов!</b>
    </div>
    <table class="bank-properties">
    ...
    <a href="<?php echo $sdHost;?>/in/offer/250?aid=63223&source=<?php echo $source;?>&campaign=<?php echo $campaign;?>&promo=<?php echo $medium;?>&tid1=<?php echo $content;?>&tid2=<?php echo $tid2;?>" onclick="fbq('track', 'Lead');" id="moneyveo" target="_blank" class="bank-link">Получить займ</a>
</div>                 
                    
                    
   <div class="bank m" style="cursor: pointer;" onclick="window.open('<?php echo $sdHost;?>/in/offer/1986?aid=63223&source=adwords&campaign=<?php echo $gclid;?>&promo=<?php echo $promo;?>&tid1=UA-113174594-1&tid2=<?php echo $tid2;?>');fbq('track', 'Lead');">
    <a href="<?php echo $sdHost;?>/in/offer/1986?aid=63223&source=adwords&campaign=<?php echo $gclid;?>&promo=<?php echo $promo;?>&tid1=UA-113174594-1&tid2=<?php echo $tid2;?>" onclick="fbq('track', 'Lead');" target="_blank" id="creditkasa" class="bank-img"><img id="creditkasa" src="images/ccloan.png" alt="creditkasa"></a>
    ...
    <a href="<?php echo $sdHost;?>/in/offer/1986?aid=63223&source=adwords&campaign=<?php echo $gclid;?>&promo=<?php echo $promo;?>&tid1=UA-113174594-1&tid2=<?php echo $tid2;?>" onclick="fbq('track', 'Lead');" id="creditkasa" target="_blank" class="bank-link">Получить займ</a>
</div>                    
               
                    
       
<div class="bank">
    <a href="<?php echo $sdHost;?>/in/offer/2099?aid=63223&source=<?php echo $source;?>&campaign=<?php echo $campaign;?>&promo=<?php echo $medium;?>&tid1=<?php echo $content;?>&tid2=<?php echo $tid2;?>" onclick="fbq('track', 'Lead');" target="_blank" id="alexcredit" class="bank-img"><img id="alexcredit" src="images/kredit7.jpg" alt="Alex"></a>
    <div class="bank-features">
        <b>Под 0 процентов!</b>
    </div>
    <table class="bank-properties">
    ...
    <a href="<?php echo $sdHost;?>/in/offer/2099?aid=63223&source=<?php echo $source;?>&campaign=<?php echo $campaign;?>&promo=<?php echo $medium;?>&tid1=<?php echo $content;?>&tid2=<?php echo $tid2;?>" onclick="fbq('track', 'Lead');" id="alexcredit" target="_blank" class="bank-link">Получить займ</a>
</div>                       
 ...
 <div class="bank">
    <a href="<?php echo $sdHost;?>/in/offer/1960?aid=63223&source=<?php echo $source;?>&campaign=<?php echo $campaign;?>&promo=<?php echo $medium;?>&tid1=<?php echo $content;?>&tid2=<?php echo $tid2;?>" onclick="fbq('track', 'Lead');" target="_blank" id="alexcredit" class="bank-img"><img id="alexcredit" src="images/gofingo_logo.png" alt="Alex"></a>
    <div class="bank-features">
        <b>Под 1,7 процентов!</b>
    </div>
    <table class="bank-properties">
        <tr class="bank-property">
            <td>
    ...
    <a href="<?php echo $sdHost;?>/in/offer/1960?aid=63223&source=<?php echo $source;?>&campaign=<?php echo $campaign;?>&promo=<?php echo $medium;?>&tid1=<?php echo $content;?>&tid2=<?php echo $tid2;?>" onclick="fbq('track', 'Lead');" id="alexcredit" target="_blank" class="bank-link">Получить займ</a>
</div> 
...
" alt="Moneyveo"></a>
    ...
    <a href="<?php echo $sdHost;?>/in/offer/1272?aid=63223&source=<?php echo $source;?>&campaign=<?php echo $campaign;?>&promo=<?php echo $medium;?>&tid1=<?php echo $content;?>&tid2=<?php echo $tid2;?>" onclick="fbq('track', 'Lead');" id="svgroshi" target="_blank" class="bank-link">Получить займ</a>
          ...
          <!-- <div class="bank">
    <a href="<?php echo $sdHost;?>/in/offer/1492?aid=63223&source=<?php echo $source;?>&campaign=<?php echo $campaign;?>&promo=<?php echo $medium;?>&tid1=<?php echo $content;?>&tid2=<?php echo $tid2;?>" onclick="fbq('track', 'Lead');" target="_blank" id="creditkasa" class="bank-img"><img id="creditkasa" src="images/creditkasa.jpg" alt="creditkasa"></a>
    ...
    <a href="<?php echo $sdHost;?>/in/offer/1492?aid=63223&source=<?php echo $source;?>&campaign=<?php echo $campaign;?>&promo=<?php echo $medium;?>&tid1=<?php echo $content;?>&tid2=<?php echo $tid2;?>" onclick="fbq('track', 'Lead');" id="creditkasa" target="_blank" class="bank-link">Получить займ</a>
</div>   -->
