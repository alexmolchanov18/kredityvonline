...
<script>
  ...
  OneSignal.push(function() {
    ...
    .bottom-banner{position:relative;width: 100%;max-width: 1070px;margin: 0 auto;height: auto;max-height: 150px; padding-bottom: 25px;}
      .bottom-banner img{width: 100%;height: auto;max-height: 150px;}
...
<!-- End Google Tag Manager (noscript) -->
    ...
    <div class="wrapper">
        <header class="page-header" id="headers">
            <div class="container"><a href="https://go.salesdoubler.net/in/offer/1261?aid=63223&source=undefined&campaign=buttonlink&promo=undefined&tid1=UA-113174594-1&tid2=282ac8da-d739-4743-8afb-36e91fa35b20&_ga=2.190139368.230020834.1540199205-n%" style="text-decoration: none;"> <img src="banner.png" alt="banner"></a>
...
<!--                <div class="header-circle-1"></div>
        ...
        <main>
            <div class="container c">
                <p class="zag"><span>ЗАЙМ НА КАРТУ</span> —
                 онлайн-оформление кредитов и займов 24/7!</p>
                <div class="banks">
                    
                    <div class="bank m">
    <a href="<?php echo $sdHost;?>/in/offer/1436?aid=63223&source=<?php echo $source;?>&campaign=buttonlink&promo=<?php echo $promo;?>&tid1=UA-113174594-1&tid2=<?php echo $tid2;?>" onclick="fbq('track', 'Lead');" target="_blank" id="creditplus" class="bank-img"><img id="creditplus" src="images/miloan.jpg" alt="vasha"></a>
    ...
    <a href="<?php echo $sdHost;?>/in/offer/1436?aid=63223&source=<?php echo $source;?>&campaign=buttonlink&promo=<?php echo $promo;?>&tid1=UA-113174594-1&tid2=<?php echo $tid2;?>" onclick="fbq('track', 'Lead');" id="vasha" target="_blank" class="bank-link">Получить займ</a>
                    ...
                    <div class="bank m">
    <a href="<?php echo $sdHost;?>/in/offer/1272?aid=63223&source=<?php echo $source;?>&campaign=buttonlink&promo=<?php echo $promo;?>&tid1=UA-113174594-1&tid2=<?php echo $tid2;?>" onclick="fbq('track', 'Lead');" id="svgroshi" target="_blank" class="bank-img"><img  id="svgroshi" src="images/shvidko-groshi-min.png
" alt="Moneyveo"></a>
    <div class="bank-features">
        <b>Под 2 процента!</b>
    </div>
    ...
    <a href="<?php echo $sdHost;?>/in/offer/1272?aid=63223&source=<?php echo $source;?>&campaign=buttonlink&promo=<?php echo $promo;?>&tid1=UA-113174594-1&tid2=<?php echo $tid2;?>" onclick="fbq('track', 'Lead');" id="svgroshi" target="_blank" class="bank-link">Получить займ</a>
               ...
               <div class="bank m">
    <a href="<?php echo $sdHost;?>/in/offer/1261?aid=63223&source=<?php echo $source;?>&campaign=buttonlink&promo=<?php echo $promo;?>&tid1=UA-113174594-1&tid2=<?php echo $tid2;?>" onclick="fbq('track', 'Lead');" id="mycredit" target="_blank" class="bank-img"><img id="mycredit" src="images/mycredit.svg" alt="creditkasa"></a>
    ...
    <div class="bank m">
    <a href="<?php echo $sdHost;?>/in/offer/1492?aid=63223&source=<?php echo $source;?>&campaign=buttonlink&promo=<?php echo $promo;?>&tid1=UA-113174594-1&tid2=<?php echo $tid2;?>" onclick="fbq('track', 'Lead');" target="_blank" id="creditkasa" class="bank-img"><img id="creditkasa" src="images/creditkasa.jpg" alt="creditkasa"></a>
    ...
    <a href="<?php echo $sdHost;?>/in/offer/1492?aid=63223&source=<?php echo $source;?>&campaign=buttonlink&promo=<?php echo $promo;?>&tid1=UA-113174594-1&tid2=<?php echo $tid2;?>" onclick="fbq('track', 'Lead');" id="creditkasa" target="_blank" class="bank-link">Получить займ</a>
</div>   
                      

                    
                    <div class="bank">
    <a href="<?php echo $sdHost;?>/in/offer/1509?aid=63223&source=<?php echo $source;?>&campaign=buttonlink&promo=<?php echo $promo;?>&tid1=UA-113174594-1&tid2=<?php echo $tid2;?>" onclick="fbq('track', 'Lead');" target="_blank" id="alexcredit" class="bank-img"><img id="alexcredit" src="images/alexcredit.jpg" alt="Alex"></a>
    <div class="bank-features">
        <b>Под 0 процентов!</b>
    </div>
    <table class="bank-properties">
...
<div class="bank">
    <a href="<?php echo $sdHost;?>/in/offer/1571?aid=63223&source=<?php echo $source;?>&campaign=buttonlink&promo=<?php echo $promo;?>&tid1=UA-113174594-1&tid2=<?php echo $tid2;?>" onclick="fbq('track', 'Lead');" target="_blank" id="dinero" class="bank-img"><img id="dinero" src="images/dinero.png" alt="Dinero"></a>
    <div class="bank-features">
        <b>Под 0 процентов!</b>
    ...
    <div class="bank">
    <a href="<?php echo $sdHost;?>/in/offer/250?aid=63223&source=<?php echo $source;?>&campaign=buttonlink&promo=<?php echo $promo;?>&tid1=UA-113174594-1&tid2=<?php echo $tid2;?>" onclick="fbq('track', 'Lead');" target="_blank" id="moneyveo" class="bank-img"><img id="moneyveo" src="images/moneyveo.png" alt="Moneyveo"></a>
    <div class="bank-features">
        <b>Под 0 процентов!</b>
    </div>
    <table class="bank-properties">
    ...
    <div class="bank">
    <a href="<?php echo $sdHost;?>/in/offer/1556?aid=63223&source=<?php echo $source;?>&campaign=buttonlink&promo=<?php echo $promo;?>&tid1=UA-113174594-1&tid2=<?php echo $tid2;?>" onclick="fbq('track', 'Lead');" target="_blank" id="forza" class="bank-img"><img id="forza" src="images/cashinsky.png" alt="forza"></a>
    ...
    <a href="<?php echo $sdHost;?>/in/offer/1556?aid=63223&source=<?php echo $source;?>&campaign=buttonlink&promo=<?php echo $promo;?>&tid1=UA-113174594-1&tid2=<?php echo $tid2;?>" onclick="fbq('track', 'Lead');" id="forza" target="_blank" class="bank-link">Получить займ</a>
</div>     
...
<div class="bank">
    ...
    <a href="<?php echo $sdHost;?>/in/offer/1571?aid=63223&source=<?php echo $source;?>&campaign=buttonlink&promo=<?php echo $promo;?>&tid1=UA-113174594-1&tid2=<?php echo $tid2;?>" onclick="fbq('track', 'Lead');" id="dinero" target="_blank" class="bank-link">Получить займ</a>
          ...
          <!-- <div class="bank">
    <a href="<?php echo $sdHost;?>/in/offer/1736?aid=63223&source=<?php echo $source;?>&campaign=buttonlink&promo=<?php echo $promo;?>&tid1=UA-113174594-1&tid2=<?php echo $tid2;?>" onclick="fbq('track', 'Lead');" target="_blank" id="creditlife" class="bank-img"><img id="dinero" src="images/creditlife.png
" alt="creditlife"></a>
    <div class="bank-features">
        <b>Под 0 процентов!</b>
    ...
    <a href="<?php echo $sdHost;?>/in/offer/1736?aid=63223&source=<?php echo $source;?>&campaign=buttonlink&promo=<?php echo $promo;?>&tid1=UA-113174594-1&tid2=<?php echo $tid2;?>" onclick="fbq('track', 'Lead');" id="dinero" target="_blank" class="bank-link">Получить займ</a>
              ...
              -->      
                ...
                <div class="bottom-banner">
                    <a href="https://go.salesdoubler.net/in/offer/1261?aid=63223&source=undefined&campaign=buttonlink&promo=undefined&tid1=UA-113174594-1&tid2=282ac8da-d739-4743-8afb-36e91fa35b20&_ga=2.190139368.230020834.1540199205-n%" style="text-decoration: none;"> <img src="banner.png" alt="banner"></a>
                </div>
                <div class="main-text">
