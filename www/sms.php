...
<div class="bank">
 ...
 <div class="bank">
    <a href="<?php echo $sdHost;?>/in/offer/1711?aid=63223&source=<?php echo $source;?>&campaign=<?php echo $campaign;?>&promo=<?php echo $medium;?>&tid1=<?php echo $content;?>&tid2=<?php echo $tid2;?>" onclick="fbq('track', 'Lead');" target="_blank" id="creditplus" class="bank-img"><img id="creditplus" src="images/egrlogo.png" alt="vasha"></a>
    <div class="bank-features">
        <b>Под 0 процентов!</b>
    </div>
    <table class="bank-properties">
    ...
    <a href="<?php echo $sdHost;?>/in/offer/1711?aid=63223&source=<?php echo $source;?>&campaign=<?php echo $campaign;?>&promo=<?php echo $medium;?>&tid1=<?php echo $content;?>&tid2=<?php echo $tid2;?>" onclick="fbq('track', 'Lead');" id="vasha" target="_blank" class="bank-link">Получить займ</a>
</div>  
