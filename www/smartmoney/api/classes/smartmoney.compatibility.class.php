<?php
/**
 * SmartMoney API Integration Class
 */
class SmartMoneyAPI
{
    const REMOTE_URL = 'https://api.smartmoney.best/statistics/send/';
    ...
    {
        return $this->_getUserDataParam('first_name', false);
    }

    private function _getSecondName()
    {
        return $this->_getUserDataParam('second_name', false);
    }
    ...
    {
        $phone = (string) $this->_getUserDataParam('phone', true);
    ...
    {
        $this->_response(true, static::DEFAULT_SUCCESS_MESSAGE);
    }

    private function _response($status = false, $message = '')
    {
        $status  = (bool) $status;
        $message = (string) $message;
