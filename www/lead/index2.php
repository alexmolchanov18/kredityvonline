...
<!-- End Google Tag Manager (noscript) -->
		...
		<main>
			<div class="container">
                <div class="banks">
                    ...
                    <div class="bank" onclick="window.open('<?php echo $sdHost;?>/in/offer/1436?aid=63223&source=<?php echo $source;?>&campaign=fulllink&promo=<?php echo $promo;?>&tid1=UA-113174594-1&tid2=<?php echo $tid2;?>'); fbq('track', 'Lead'); " >
    <a href="<?php echo $sdHost;?>/in/offer/1436?aid=63223&source=<?php echo $source;?>&campaign=fulllink&promo=<?php echo $promo;?>&tid1=UA-113174594-1&tid2=<?php echo $tid2;?>" onclick="fbq('track', 'Lead');" target="_blank" id="creditplus" class="bank-img"><img id="creditplus" src="images/miloan.jpg" alt="vasha"></a>
    ...
    <a href="<?php echo $sdHost;?>/in/offer/1436?aid=63223&source=<?php echo $source;?>&campaign=fulllink&promo=<?php echo $promo;?>&tid1=UA-113174594-1&tid2=<?php echo $tid2;?>" onclick="fbq('track', 'Lead');" id="vasha" target="_blank" class="bank-link">Получить займ</a>
</div> 
         

                    <div class="bank" onclick="window.open('<?php echo $sdHost;?>/in/offer/1272?aid=63223&source=<?php echo $source;?>&campaign=fulllink&promo=<?php echo $promo;?>&tid1=UA-113174594-1&tid2=<?php echo $tid2;?>'); fbq('track', 'Lead');">
    <a href="<?php echo $sdHost;?>/in/offer/1272?aid=63223&source=<?php echo $source;?>&campaign=fulllink&promo=<?php echo $promo;?>&tid1=UA-113174594-1&tid2=<?php echo $tid2;?>" onclick="fbq('track', 'Lead');" id="svgroshi" target="_blank" class="bank-img"><img  id="svgroshi" src="images/shvidko-groshi-min.png
" alt="Moneyveo"></a>
    <div class="bank-features">
        <b>Под 2 процента!</b>
    </div>
    ...
    <a href="<?php echo $sdHost;?>/in/offer/1272?aid=63223&source=<?php echo $source;?>&campaign=fulllink&promo=<?php echo $promo;?>&tid1=UA-113174594-1&tid2=<?php echo $tid2;?>" onclick="fbq('track', 'Lead');" id="svgroshi" target="_blank" class="bank-link">Получить займ</a>
</div>
               <div class="bank" onclick="window.open('<?php echo $sdHost;?>/in/offer/1261?aid=63223&source=<?php echo $source;?>&campaign=fulllink&promo=<?php echo $promo;?>&tid1=UA-113174594-1&tid2=<?php echo $tid2;?>'); fbq('track', 'Lead');">
    <a href="<?php echo $sdHost;?>/in/offer/1261?aid=63223&source=<?php echo $source;?>&campaign=fulllink&promo=<?php echo $promo;?>&tid1=UA-113174594-1&tid2=<?php echo $tid2;?>" onclick="fbq('track', 'Lead');" id="mycredit" target="_blank" class="bank-img"><img id="mycredit" src="images/mycredit.svg" alt="creditkasa"></a>
    ...
    <a href="<?php echo $sdHost;?>/in/offer/1261?aid=63223&source=<?php echo $source;?>&campaign=fulllink&promo=<?php echo $promo;?>&tid1=UA-113174594-1&tid2=<?php echo $tid2;?>"  id="mycredit" target="_blank" class="bank-link">Получить займ</a>
</div>    
         
                
               
<div class="bank" onclick="window.open('<?php echo $sdHost;?>/in/offer/1559?aid=63223&source=<?php echo $source;?>&campaign=fulllink&promo=<?php echo $promo;?>&tid1=UA-113174594-1&tid2=<?php echo $tid2;?>'); fbq('track', 'Lead');">
    <a href="<?php echo $sdHost;?>/in/offer/1559?aid=63223&source=<?php echo $source;?>&campaign=fulllink&promo=<?php echo $promo;?>&tid1=UA-113174594-1&tid2=<?php echo $tid2;?>" onclick="fbq('track', 'Lead');" target="_blank" id="forza" class="bank-img"><img id="forza" src="images/kf.jpg" alt="forza"></a>
    ...
    <a href="<?php echo $sdHost;?>/in/offer/1559?aid=63223&source=<?php echo $source;?>&campaign=fulllink&promo=<?php echo $promo;?>&tid1=UA-113174594-1&tid2=<?php echo $tid2;?>" onclick="fbq('track', 'Lead');" id="forza" target="_blank" class="bank-link">Получить займ</a>
</div>            
          
        
 
                    
                    <div class="bank" onclick="window.open('<?php echo $sdHost;?>/in/offer/1509?aid=63223&source=<?php echo $source;?>&campaign=fulllink&promo=<?php echo $promo;?>&tid1=UA-113174594-1&tid2=<?php echo $tid2;?>'); fbq('track', 'Lead');">
    <a href="<?php echo $sdHost;?>/in/offer/1509?aid=63223&source=<?php echo $source;?>&campaign=fulllink&promo=<?php echo $promo;?>&tid1=UA-113174594-1&tid2=<?php echo $tid2;?>" onclick="fbq('track', 'Lead');" target="_blank" id="alexcredit" class="bank-img"><img id="alexcredit" src="images/alexcredit.jpg" alt="Alex"></a>
    <div class="bank-features">
        <b>Под 0 процентов!</b>
    </div>
    <table class="bank-properties">
    ...
    <a href="<?php echo $sdHost;?>/in/offer/1509?aid=63223&source=<?php echo $source;?>&campaign=fulllink&promo=<?php echo $promo;?>&tid1=UA-113174594-1&tid2=<?php echo $tid2;?>" onclick="fbq('track', 'Lead');" id="alexcredit" target="_blank" class="bank-link">Получить займ</a>
</div>  
                    
                    
<div class="bank" onclick="window.open('<?php echo $sdHost;?>/in/offer/1571?aid=63223&source=<?php echo $source;?>&campaign=fulllink&promo=<?php echo $promo;?>&tid1=UA-113174594-1&tid2=<?php echo $tid2;?>'); fbq('track', 'Lead');">
    <a href="<?php echo $sdHost;?>/in/offer/1571?aid=63223&source=<?php echo $source;?>&campaign=fulllink&promo=<?php echo $promo;?>&tid1=UA-113174594-1&tid2=<?php echo $tid2;?>" onclick="fbq('track', 'Lead');" target="_blank" id="dinero" class="bank-img"><img id="dinero" src="images/dinero.png" alt="Dinero"></a>
    <div class="bank-features">
        <b>Под 0 процентов!</b>
    ...
    <a href="<?php echo $sdHost;?>/in/offer/1571?aid=63223&source=<?php echo $source;?>&campaign=fulllink&promo=<?php echo $promo;?>&tid1=UA-113174594-1&tid2=<?php echo $tid2;?>" onclick="fbq('track', 'Lead');" id="dinero" target="_blank" class="bank-link">Получить займ</a>
</div>                      
     
                    
                    <div class="bank" onclick="window.open('<?php echo $sdHost;?>/in/offer/852?aid=63223&source=<?php echo $source;?>&campaign=fulllink&promo=<?php echo $promo;?>&tid1=UA-113174594-1&tid2=<?php echo $tid2;?>'); fbq('track', 'Lead');">
    <a href="<?php echo $sdHost;?>/in/offer/852?aid=63223&source=<?php echo $source;?>&campaign=fulllink&promo=<?php echo $promo;?>&tid1=UA-113174594-1&tid2=<?php echo $tid2;?>" onclick="fbq('track', 'Lead');" target="_blank" id="forza" class="bank-img"><img id="bystro" src="images/bystro.jpg" alt="bystro"></a>
    ...
    <a href="<?php echo $sdHost;?>/in/offer/852?aid=63223&source=<?php echo $source;?>&campaign=fulllink&promo=<?php echo $promo;?>&tid1=UA-113174594-1&tid2=<?php echo $tid2;?>" onclick="fbq('track', 'Lead');" id="forza" target="_blank" class="bank-link">Получить займ</a>
</div>   
                    
                    
    <div class="bank" onclick="window.open('<?php echo $sdHost;?>/in/offer/250?aid=63223&source=<?php echo $source;?>&campaign=fulllink&promo=<?php echo $promo;?>&tid1=UA-113174594-1&tid2=<?php echo $tid2;?>'); fbq('track', 'Lead');">
    <a href="<?php echo $sdHost;?>/in/offer/250?aid=63223&source=<?php echo $source;?>&campaign=fulllink&promo=<?php echo $promo;?>&tid1=UA-113174594-1&tid2=<?php echo $tid2;?>" onclick="fbq('track', 'Lead');" target="_blank" id="moneyveo" class="bank-img"><img id="moneyveo" src="images/moneyveo.png" alt="Moneyveo"></a>
    <div class="bank-features">
        <b>Под 0 процентов!</b>
    </div>
    <table class="bank-properties">
    ...
    <a href="<?php echo $sdHost;?>/in/offer/250?aid=63223&source=<?php echo $source;?>&campaign=fulllink&promo=<?php echo $promo;?>&tid1=UA-113174594-1&tid2=<?php echo $tid2;?>" onclick="fbq('track', 'Lead');" id="moneyveo" target="_blank" class="bank-link">Получить займ</a>
</div>     
...
<div class="bank" onclick="window.open('<?php echo $sdHost;?>/in/offer/1571?aid=63223&source=<?php echo $source;?>&campaign=fulllink&promo=<?php echo $promo;?>&tid1=UA-113174594-1&tid2=<?php echo $tid2;?>'); fbq('track', 'Lead');">
    ...
    <a href="<?php echo $sdHost;?>/in/offer/1571?aid=63223&source=<?php echo $source;?>&campaign=fulllink&promo=<?php echo $promo;?>&tid1=UA-113174594-1&tid2=<?php echo $tid2;?>" onclick="fbq('track', 'Lead');" id="dinero" target="_blank" class="bank-link">Получить займ</a>
          ...
          <!-- <div class="bank">
    <a href="<?php echo $sdHost;?>/in/offer/1736?aid=63223&source=<?php echo $source;?>&campaign=fulllink&promo=<?php echo $promo;?>&tid1=UA-113174594-1&tid2=<?php echo $tid2;?>" onclick="fbq('track', 'Lead');" target="_blank" id="creditlife" class="bank-img"><img id="dinero" src="images/creditlife.png
" alt="creditlife"></a>
    <div class="bank-features">
        <b>Под 0 процентов!</b>
    ...
    <a href="<?php echo $sdHost;?>/in/offer/1736?aid=63223&source=<?php echo $source;?>&campaign=&promo=<?php echo $promo;?>&tid1=UA-113174594-1&tid2=<?php echo $tid2;?>" onclick="fbq('track', 'Lead');" id="dinero" target="_blank" class="bank-link">Получить займ</a>
</div>  
              -->      
