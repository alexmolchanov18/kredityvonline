<?php
    ...
    if (!empty($_GET['s'])) {
        $sessionID = addslashes(htmlspecialchars(trim($_GET['s'])));
        include_once(__DIR__.'/RotatorAPI.php');
        $rotatorAPI = new RotatorAPI($sessionID);
        $ids = $rotatorAPI->getOffersIDs();
        ...
        foreach ($ids as $id) {
            $rotatorJS = $rotatorJS.'document.getElementById("'.$id.'").style.display = "none";'."\n";
        }
        $rotatorAPI->debug();
    } else {
        header('Location: /');
...
<!-- End Google Tag Manager (noscript) -->
 ...
 <div id="1436" class="bank">
    <a href="<?php echo $sdHost;?>/in/offer/1436?aid=63223&source=<?php echo $source;?>&campaign=<?php echo $campaign;?>&promo=<?php echo $medium;?>&tid1=<?php echo $promo;?>&tid2=<?php echo $tid2;?>" onclick="fbq('track', 'Lead');" target="_blank" id="creditplus" class="bank-img"><img id="creditplus" src="images/miloan.jpg" alt="vasha"></a>
    ...
    <a href="<?php echo $sdHost;?>/in/offer/1436?aid=63223&source=<?php echo $source;?>&campaign=<?php echo $campaign;?>&promo=<?php echo $medium;?>&tid1=<?php echo $promo;?>&tid2=<?php echo $tid2;?>" onclick="fbq('track', 'Lead');" id="vasha" target="_blank" class="bank-link">Получить займ</a>
</div>  
                    
                    
    <div id="1492" class="bank">
    <a href="<?php echo $sdHost;?>/in/offer/1492?aid=63223&source=<?php echo $source;?>&campaign=<?php echo $campaign;?>&promo=<?php echo $medium;?>&tid1=<?php echo $promo;?>&tid2=<?php echo $tid2;?>" onclick="fbq('track', 'Lead');" target="_blank" id="creditkasa" class="bank-img"><img id="creditkasa" src="images/creditkasa.jpg" alt="creditkasa"></a>
    ...
    <a href="<?php echo $sdHost;?>/in/offer/1492?aid=63223&source=<?php echo $source;?>&campaign=<?php echo $campaign;?>&promo=<?php echo $medium;?>&tid1=<?php echo $promo;?>&tid2=<?php echo $tid2;?>" onclick="fbq('track', 'Lead');" id="creditkasa" target="_blank" class="bank-link">Получить займ</a>
</div>   
...
<div id="1509" class="bank">
    <a href="<?php echo $sdHost;?>/in/offer/1509?aid=63223&source=<?php echo $source;?>&campaign=<?php echo $campaign;?>&promo=<?php echo $medium;?>&tid1=<?php echo $promo;?>&tid2=<?php echo $tid2;?>" onclick="fbq('track', 'Lead');" target="_blank" id="alexcredit" class="bank-img"><img id="alexcredit" src="images/alexcredit.jpg" alt="Alex"></a>
    <div class="bank-features">
        <b>Под 0 процентов!</b>
    </div>
    <table class="bank-properties">
    ...
    <a href="<?php echo $sdHost;?>/in/offer/1509?aid=63223&source=<?php echo $source;?>&campaign=<?php echo $campaign;?>&promo=<?php echo $medium;?>&tid1=<?php echo $promo;?>&tid2=<?php echo $tid2;?>" onclick="fbq('track', 'Lead');" id="alexcredit" target="_blank" class="bank-link">Получить займ</a>
</div>                       
                    
            
                    
                    
    <div id="1272" class="bank">
    <a href="<?php echo $sdHost;?>/in/offer/1272?aid=63223&source=<?php echo $source;?>&campaign=<?php echo $campaign;?>&promo=<?php echo $medium;?>&tid1=<?php echo $promo;?>&tid2=<?php echo $tid2;?>" onclick="fbq('track', 'Lead');" id="svgroshi" target="_blank" class="bank-img"><img  id="svgroshi" src="images/shvidko-groshi-min.png
" alt="Moneyveo"></a>
    <div class="bank-features">
        <b>Под 2 процента!</b>
    </div>
    ...
    <a href="<?php echo $sdHost;?>/in/offer/1272?aid=63223&source=<?php echo $source;?>&campaign=<?php echo $campaign;?>&promo=<?php echo $medium;?>&tid1=<?php echo $promo;?>&tid2=<?php echo $tid2;?>" onclick="fbq('track', 'Lead');" id="svgroshi" target="_blank" class="bank-link">Получить займ</a>
</div>                  
       
        <div id="250" class="bank">
    <a href="<?php echo $sdHost;?>/in/offer/250?aid=63223&source=<?php echo $source;?>&campaign=<?php echo $campaign;?>&promo=<?php echo $medium;?>&tid1=<?php echo $promo;?>&tid2=<?php echo $tid2;?>" onclick="fbq('track', 'Lead');" target="_blank" id="moneyveo" class="bank-img"><img id="moneyveo" src="images/moneyveo.png" alt="Moneyveo"></a>
    <div class="bank-features">
        <b>Под 0 процентов!</b>
    </div>
    <table class="bank-properties">
    ...
    <a href="<?php echo $sdHost;?>/in/offer/250?aid=63223&source=<?php echo $source;?>&campaign=<?php echo $campaign;?>&promo=<?php echo $medium;?>&tid1=<?php echo $promo;?>&tid2=<?php echo $tid2;?>" onclick="fbq('track', 'Lead');" id="moneyveo" target="_blank" class="bank-link">Получить займ</a>
</div>  
    
                    
                    <div id="1727" class="bank">
    <a href="<?php echo $sdHost;?>/in/offer/1727?aid=63223&source=<?php echo $source;?>&campaign=<?php echo $campaign;?>&promo=<?php echo $medium;?>&tid1=<?php echo $promo;?>&tid2=<?php echo $tid2;?>" onclick="fbq('track', 'Lead');" target="_blank" id="dinero" class="bank-img"><img id="dinero" src="images/cashberry-logo.png" alt="Dinero"></a>
    <div class="bank-features">
        <b>Под 0 процентов!</b>
    ...
    <a href="<?php echo $sdHost;?>/in/offer/1727?aid=63223&source=<?php echo $source;?>&campaign=<?php echo $campaign;?>&promo=<?php echo $medium;?>&tid1=<?php echo $promo;?>&tid2=<?php echo $tid2;?>" onclick="fbq('track', 'Lead');" id="dinero" target="_blank" class="bank-link">Получить займ</a>
</div>  
                    
                    
                    
<div id="1571" class="bank">
    <a href="<?php echo $sdHost;?>/in/offer/1571?aid=63223&source=<?php echo $source;?>&campaign=<?php echo $campaign;?>&promo=<?php echo $medium;?>&tid1=<?php echo $promo;?>&tid2=<?php echo $tid2;?>" onclick="fbq('track', 'Lead');" target="_blank" id="dinero" class="bank-img"><img id="dinero" src="images/dinero.png" alt="Dinero"></a>
    <div class="bank-features">
        <b>Под 0 процентов!</b>
    ...
    <a href="<?php echo $sdHost;?>/in/offer/1571?aid=63223&source=<?php echo $source;?>&campaign=<?php echo $campaign;?>&promo=<?php echo $medium;?>&tid1=<?php echo $promo;?>&tid2=<?php echo $tid2;?>" onclick="fbq('track', 'Lead');" id="dinero" target="_blank" class="bank-link">Получить займ</a>
</div>                     
                    
     
                    
               <div id="1844" class="bank">
    <a href="<?php echo $sdHost;?>/in/offer/1844?aid=63223&source=<?php echo $source;?>&campaign=<?php echo $campaign;?>&promo=<?php echo $medium;?>&tid1=<?php echo $promo;?>&tid2=<?php echo $tid2;?>" onclick="fbq('track', 'Lead');" id="mycredit" target="_blank" class="bank-img"><img id="mycredit" src="images/creditplus.png" alt="creditkasa"></a>
    ...
    <a href="<?php echo $sdHost;?>/in/offer/1844?aid=63223&source=<?php echo $source;?>&campaign=<?php echo $campaign;?>&promo=<?php echo $medium;?>&tid1=<?php echo $promo;?>&tid2=<?php echo $tid2;?>"  id="mycredit" target="_blank" class="bank-link">Получить займ</a>
</div>    
