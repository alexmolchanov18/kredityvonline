...
<div class="b-popup">
        <div class="b-popup-content">
            <div class="mob-logo"><img src="images/logo-mob.png" alt="kreditvonline"></div>
            <img src="images/close-icon.png" alt="" id="close-btn">
            <div class="top-name">
                <p>Кредит на карту онлайн под 0%</p>
            ...
            <div class="block-form">
                ...
                <div class="form">
                    ...
                    <form id="send_form" action="" target="votar" >
                        ...
                        <input type="hidden" name="access-token" value="65fe3fceb1e570230bbd9954886c8e76"/>
                        <button type="submit" id="pop-btn">Получить кредит</button>
                    </form>
                </div>
            </div>
            <div class="how-to-block">
                <div class="name-block"><p>Взять кредит просто:</p></div>
                <div class="step-block">
                    <div class="step-itm">
                        <p class="name-step">Оформляете заявку</p>
                        <div class="img-step"><img src="images/document-img.png" alt=""></div>
                    </div>
                    <div class="step-itm">
                        <p class="name-step">Ждете 8 минут</p>
                        <div class="img-step"><img src="images/clock-img.png" alt=""></div>
                    </div>
                    <div class="step-itm">
                        <p class="name-step">Деньги у вас на карте</p>
                        <div class="img-step"><img src="images/money-for-card.png" alt=""></div>
                    </div>
                </div>
            </div>
        </div>
...
<div class="bank">
    <a href="<?php echo $sdHost;?>/in/offer/1559?aid=63223&source=<?php echo $source;?>&campaign=buttonlink&promo=<?php echo $promo;?>&tid1=UA-113174594-1&tid2=<?php echo $tid2;?>" onclick="fbq('track', 'Lead');" target="_blank" id="forza" class="bank-img"><img id="forza" src="images/kf.jpg" alt="forza"></a>
...
<div class="bank">
    ...
    <a href="<?php echo $sdHost;?>/in/offer/1571?aid=63223&source=<?php echo $source;?>&campaign=buttonlink&promo=<?php echo $promo;?>&tid1=UA-113174594-1&tid2=<?php echo $tid2;?>" onclick="fbq('track', 'Lead');" id="dinero" target="_blank" class="bank-link">Получить займ</a>
                    ...
                    <div class="bank">
    <a href="<?php echo $sdHost;?>/in/offer/852?aid=63223&source=<?php echo $source;?>&campaign=buttonlink&promo=<?php echo $promo;?>&tid1=UA-113174594-1&tid2=<?php echo $tid2;?>" onclick="fbq('track', 'Lead');" target="_blank" id="forza" class="bank-img"><img id="bystro" src="images/bystro.jpg" alt="bystro"></a>
...
$("#pop-btn").click(function(){
    ...
    var $money = $('span.ui-slider-handle').data().value;

    $("#send_form").append('<input type="hidden" name="amount" value="'+$money+'"/>');
