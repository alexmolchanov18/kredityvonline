...
$link = "http://kredityvonline.com/catalog/aftermail.php";

$q = "";
if (!empty($_REQUEST['q'])) {
    $q = substr(htmlspecialchars(trim($_REQUEST['q'])),0,200);
}
$aid_q_link = "?aid=".$aid."&q=".$q;
$linkQuery = $link.$aid_q_link;
                ...
                <div class="col-sm-12 col-md-9 color_white text_bold calculator_inner">
                    ...
                    <div class="row m_t_50" style="position: relative; top: -40px;">
                        <div class="col-xs-12 col-sm-12">
                            ...
                            <a class="rdr" href="#" data-href="http://kredityvonline.com/catalog/"   style="text-decoraton:none; padding:10px; font-size:1em; color: white;">
...
<div class="container" align="center">
    ...
    <div class="a-btn">
        <a class="rdr" href="#" data-href="http://kredityvonline.com/catalog/"  >Выбрать лучшее<br> предложение самостоятельно</a>
    </div>
</div>
...
кредитную историю, которая в будущем поможет Вам при получении кредитов на большие суммы.
    ...
    <div class="text__five" style="color: #343233;">Сервис kredityvonline.com</div>
    <div class="text__sex" style="color: #343233;">
...
<div class="header__bg">
   ...
   ">
    ...
    <div align="center"> <div class="a-btn">
            <a class="rdr" href="#" data-href="http://kredityvonline.com/catalog/"  >Смотреть кредитные предложения</a>
    </div></div>
    </div>
...
<script type="text/javascript">
    ...
    $('a.rdr').each(function(){
        ...
        link = link1st+'<?php echo $aid_q_link;?>';
        link = link.replace(/#/g,'');
    ...
    $('#btn_send').click(function(e) {
        ...
        location.href='<?php echo $linkQuery;?>';
